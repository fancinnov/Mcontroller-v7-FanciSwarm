...
#ifndef __COMPASSCALIBRATOR_H
#define __COMPASSCALIBRATOR_H
...
//RMS tolerance
#define COMPASS_CAL_DEFAULT_TOLERANCE 30.0f
...
public:
    ...
    void set_orientation(enum Rotation orientation, bool is_external, bool fix_orientation, bool check_orientation) {
        _check_orientation = check_orientation;
    ...
    uint16_t get_fit_step() const{ return _fit_step;}
